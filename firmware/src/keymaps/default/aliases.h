...
#define _GRAVE_	 KC_GRV            // '`' | Tilde
#define _QUOTE_	 KC_QUOTE          //  '  | Single Quote

// SPACIAL CHARACTERS

#define _ESC_    KC_ESCAPE
...
// Undo / Redo
#define _UNDO_   LCTL(KC_Z)    // ‘Undo’   (e.g. V on your Nav layer)
#define _REDO_   LCTL(KC_Y)    // ‘Redo’   (e.g. J on your Nav layer)

// Cut / Copy / Paste
#define _CUT_    LCTL(KC_X)    // ‘Cut’    (e.g. S / Y)
#define _COPY_   LCTL(KC_C)    // ‘Copy’   (e.g. H / U)
#define _PASTE_  LCTL(KC_V)    // ‘Paste’  (e.g. M / L)

// Arrow cluster
#define _LEFT_   KC_LEFT       // ←        (you already have _LEFT__ but for consistency)
#define _RIGHT_  KC_RIGHT      // →        (you already have _RIGHT_)
#define _UP_     KC_UP         // ↑        (you already have __UP___)
#define _DOWN_   KC_DOWN       // ↓        (you already have _DOWN__)

// Home / End / PgUp / PgDn
#define _HOME_   KC_HOME       // Home     (e.g. H on Nav layer)
#define _END_    KC_END        // End      (e.g. / on Nav layer)
#define _PGUP_   KC_PGUP       // Page Up  (e.g. . on Nav layer)
#define _PGDN_   KC_PGDN       // Page Dn  (e.g. ' on Nav layer)

// Lock / Insert
#define _CAPSLOCK_ KC_CAPS    // Caps Lock
#define _INSERT_   KC_INS     // Insert

// MEDIA layer

// Volume / Media controls
#define _VOLDN_  KC_VOLD       // Vol –    (blue icon on E)
#define _VOLUP_  KC_VOLU       // Vol +    (blue icon on I)
#define _MPRV_   KC_MPRV       // Prev     (blue icon on N)
#define _MNXT_   KC_MNXT       // Next     (blue icon on O)
#define _MPLY_   KC_MPLY       // Play/Pause (if you plan to use it)
...
//SYSTEM KEYS
#define _PRTSC_     KC_PSCR     // Print Screen
#define _SLCK_      KC_SLCT     // Scroll Lock
#define _PAUSE_     KC_PAUS     // Pause / Break
